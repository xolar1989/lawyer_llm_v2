...
class ScriptArguments:
    ...
    matryoshka_dims: List[int] = field(
        default_factory=lambda: [768, 512, 256, 128, 64],
        metadata={
            "help": (
                "List of integer dimensions (e.g. 768 512 256) used for "
                "Matryoshka loss/evaluation, or any other purpose."
            )
        },
    )
...
def training_function(script_args):
    ...
    matryoshka_dimensions = script_args.matryoshka_dims  # Important: large to small
